...
<div class="location">当前位置:
  ...
  →
  <a href="./index.php?m=system&s=managechannel">操作员后台</a>
  →
  <a href="./index.php?m=system&s=options">站点设置</a>
</div>
<div id="tabs5">
<div class="menu5box">
  <ul id="menu5">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td>移动版域名：</td>
                    <td colspan="2"><input name="mobileurl" type="text" class="txt" id="mobileurl" value="<?php echo MOBILEURL ?>" size="41" />
                      <span class="small">无独立域名可不填</span></td>
                  </tr>
                  <tr>
                    <td>站点标题：</td>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input name="urlrewrite" <?php if (URLREWRITE)echo 'checked="checked"';?> type="checkbox" id="urlrewrite" />
                      用来对搜索引擎优化<span class="small">（*此功能需要把程序放在站点根目录并且需要服务器环境支持URL重写功能,否则此功能将无法使用）</span>
                      <a href="http://www.doccms.com/seo/#jitaihua" target="_blank"><img src="./images/help.gif" alt="点击了解更多" border="0" /></a></td>
                  </tr>
                  <tr>
                    <td colspan="3"><hr></td>
                  </tr>
                  ...
                  <tr>
                    <td>选择分页样式：</td>
                    <td colspan="2"><input type="radio" name="pagestyle" id="pagestyle" <?php echo PAGESTYLE==0?'checked="true"':''?> value="0">
                      <span class="small"><img src="images/page1.png"></span> </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td colspan="2"><input type="radio" name="pagestyle" id="pagestyle" <?php echo PAGESTYLE==1?'checked="true"':''?> value="1">
                      <span class="small"><img src="images/page2.png"></span> </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td colspan="2"><input type="radio" name="pagestyle" id="pagestyle" <?php echo PAGESTYLE==2?'checked="true"':''?> value="2">
                      <span class="small"><img src="images/page3.png"></span> </td>
                  </tr>
                </table></td>
            </tr>
          </table>
              ...
              <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td colspan="2"><input name="docping" <?php echo DOCPING===true?'checked="checked"':''?> type="checkbox" id="guestbookauditing" onclick="return confirm('开启此选项前需要您拥有一个RSS订阅类型的栏目，如果还没有的话，请先至设置频道菜单中创建一个RSS类型的栏目后再开启。');"/>
                      勾选此项开启在添加新闻、产品等数据的时候系统会自动把更新的页面地址和RSS提交至百度，提醒百度您的网站有更新，加快您的网页收录速度<br />
                      <span class="small">（*开启此选项前需要您拥有一个RSS订阅类型的栏目，如果还没有的话，
                      <a href="./index.php?m=system&s=managechannel&a=create" style="color:#F00">点击此处</a>
                      创建RSS订阅类型的频道栏目。）</span></td>
                  </tr>
                  <tr>
                    <td colspan="3"><hr></td>
                  </tr>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mail">
            <tr>
              <td colspan="2"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td width="200">&nbsp;</td>
                    <td><span class="small" style="display:block; width:99%; text-align:left; line-height:30px;">此项设置为绑定允许登录网站后台的IP地址，设置完成后，非此IP的用户将无法登录后台，多个IP之间可用输入法英文状态下的分号隔开;<br />
                      如:192.168.0.1;192.168.0.2 (请慎重填写此项，如填错有可能会造成您的后台无法登录！)。</span></td>
                  </tr>
                  <tr>
                    <td colspan="3"><hr></td>
                  </tr>
          ...
          <table width="96%" border="0" cellpadding="2" cellspacing="1" align="center">
            <tr height="50">
              ...
              <td><input type="radio" name="is_pay" value="1" <?php echo PAY_ISPAY?'checked="checked"':''?>>
                ...
                否 </td>
              <td><span class="small">如果您的支付宝帐号是签约用户，可以选择"是"让网站使用您自己的商家服务平台，如果您还未签约，
                <a href="https://www.alipay.com/himalayas/practicality.htm" target="_blank">请点击这里签约</a>
                </span></td>
            </tr>
            <tr height="50">
          ...
          <table width="96%" border="0" cellpadding="4" cellspacing="1" align="center">
            <tr height="50">
              ...
              <td><input type="radio" name="is_pay_ten" value="1" <?php echo PAY_ISPAY_TEN?'checked="checked"':''?>>
                ...
                否 </td>
              <td><span class="small">如果您的财付通帐号是签约用户，可以选择"是"让网站使用您自己的商家服务平台，如果您还未签约，
                <a href="http://mch.tenpay.com/market/index.shtml" target="_blank">请点击这里签约</a>
                </span></td>
            </tr>
            <tr height="50">
              <td>商户号(partnerID) ：</td>
