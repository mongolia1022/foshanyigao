...
class Pager
{
	...
	public function Show($url,$style=0)
	{
		...
		{
			$tpageNum=8;
			$tempStr ='<ul id="docPage">';
			$tempStr .=	$this->prvNo()<1?'<li><a href="javascript:;">前一页</a></li>':'<li><a href="'.$this->rootpath.$url.$this->prvNo().$this->anchor.'">前一页</a></li>';
			...
			$tempStr .=	$this->nextNo()>$this->totalPageNo?'<li><a href="javascript:;">下一页</a></li>':'<li><a href="'.$this->rootpath.$url.$this->nextNo().$this->anchor.'">下一页</a></li>';
			$tempStr .='</ul>';
		}
		elseif($style==2)
		{
