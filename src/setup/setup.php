...
<div id="header">
	<div id="head">
    	<a href="http://www.doccms.com" target="_blank"><img src="images/logo.png" width="186" height="51" align="left" /></a><a href="http://www.doccms.com" target="_blank" class="doctitle">DocCms 2016正式版 X1.0 PHP</a>
		<div id="link">
		  <ul>
...
一、版权所有 (c) 2006-2016, Doccms.com,Shlcms.com,Doooc.com Dev Team 保留所有权力.
	...
	<div id="cright">
		<div id="install">
			<div id="crs">
				...
				<tr><td>[文件]/admini/cn_nav.php</td><td class="right">可写</td><?php echo file_mode_info('../admini/cn_nav.php')?'<td class="right">可写</td>':'<td class="wrong">不可写</td>';?></tr>
				<tr><td>[目录]/config/</td><td class="right">可写</td><?php echo file_mode_info('../config/')?'<td class="right">可写</td>':'<td class="wrong">不可写</td>';?></tr>
				<tr><td>[文件]/config/doc-config-cn.php</td><td class="right">可写</td><?php echo file_mode_info('../config/doc-config-cn.php')?'<td class="right">可写</td>':'<td class="wrong">不可写</td>';?></tr>
...
$handle2 = fopen('../config/doc-config-en.php', 'w');
$configFile2 = file_get_contents('../config/doc-config-cn.php');
fwrite($handle2, $configFile2); 
fclose($handle);
fclose($handle2);
@chmod('../config/doc-config-cn.php', 0666);
@chmod('../config/doc-config-en.php', 0666);
//测试数据库。
...
<div id="foot">
	<div id="bottom">
        ...
        <span>© 2006-2016 <a href="http://www.doccms.com" target="_blank" >DocCms X</a> design. All rights reserved. </span>
        <div id="weibo">
		  <ul>
