...
<div class="top">
	<div class="top_in">
    	<div class="logo"><a href="http://www.fsjintao.com/"><img src="<?php echo $tag['path.skin']; ?>images/logo.png" alt="门窗铝型材厂家" border="0"/></a></div>
<div class="logo_r">
        	<div class="search">
            ...
            <div class="nav">
            	<ul>
                	<li><a href="http://www.fsjintao.com/">首页</a></li>
                    <?php nav_main()?>
                </ul>
            </div>
        </div>
...
<div class="braed">
	<div class="braed_in">
    	<div class="braed_l">
        	<ul>
            	<li><a href="<?php echo sys_href(1); ?>"><?php echo sys_menu_info('title',false,1)?></a></li>
                <?php nav_sub(1,2,2);?>
            </ul>
        </div>
    	<div class="braed_r"><?php nav_location('　　/　　','首页')?></div>
    </div>
</div>
...
<div class="foot">
    ...
    </div><div class="addcontent"><a href="http://www.fsjintao.com/">佛山门窗铝型材</a> | <a href="http://www.fsjintao.com/">门窗铝型材厂家</a></div>
    <div class="foot_b">
   	  <div class="foot_b_in">
        <div class="foot_b_l">
            ...
            <div class="foot_b_r"><script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1263789022'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s13.cnzz.com/stat.php%3Fid%3D1263789022%26show%3Dpic1' type='text/javascript'%3E%3C/script%3E"));</script><!--<br>
        <a href="<?php echo $tag['path.root']; ?>/">首页</a><?php nav_main(1)?>--></div>
      </div>
    </div>
</div>
