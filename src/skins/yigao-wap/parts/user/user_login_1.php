...
<div id="stuffbox">
<p><b>用户登录</b></p>
<form name="form1" id="form1" method="post" action="<?php echo sys_href($request['p'],'login');  ?>" onsubmit="return validator()">
<input name="url" type="hidden" value="<?php echo $request['url']?>"/>
<table border="0" id="tbguest">
  ...
  <tr>
	...
	<a href="<?php echo sys_href($request['p'],'reg');?>" class="userbtn userreg">注册</a></td>
  </tr>
</table>
</form>
</div>